    ...
    return (
        <div className='relative w-full h-full'>
            <Navbar />
                ...
                <br />
                <div className='relative w-full h-full flex-col align-middle justify-center pb-10 xl:py-24 bg-black bg-opacity-50'>
                    <video
                        autoPlay
                        loop
                        muted
                    ...
                    <div className='relative z-10'>
                        <h1 className='text-gold text-5xl text-center font-bold pt-3'>PELEM</h1>
                        <br />
                        <h2 className='text-white text-center '>Hidden little hamlet In the heart of the lush countryside </h2>
                        <br />
                        <CardGrid />
                    </div>
                </div>
                ...
                <div className='relative w-full h-full align-middle justify-center xl:py-16 bg-black bg-opacity-50'>
                    ...
                    <div className='relative z-10 '>
                        ...
                        <h1 className='text-xl pt-5 text-center font-bold pb-5 md:text-2xl xl:text-3xl' style={{ color: '#DAD3BE' }}>LOKASI UMKM PADUKUAN PELEM</h1>
                        <div className='w-full h-full grid grid-cols-1 md:grid-cols-2 justify-center items-center md:h-[24rem]'>
